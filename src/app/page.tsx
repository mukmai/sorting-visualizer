...
import { algorithmOptions, generateAnimnationArray, sortingAlgorithmsData } from "@/lib/utils";
...
export default function Home() {
  ...
  const handlePlay = () => {
    ...
    generateAnimnationArray(selectedAlgorithm, isSorting, arrayToSort, runAnimation);
  }
